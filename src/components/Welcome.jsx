...
return (
    ...
    <div className="h-screen flex flex-col md:justify-center items-center ">
        ...
        <h1 className="mt-8 text-4xl md:text-7xl text-emerald-900 underline mb-12">UK Election Dash</h1>

    <div className="md:w-1/2 p-6 text-white bg-gradient-to-tl from-emerald-700 via-emerald-800 to-emerald-900 flex flex-col md:justify-center md:items-center rounded-lg">
